...
import { PHONE, PHONE_DISPLAY, ADDRESS, SITE_NAME } from "@/lib/constants";
    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-6xl mx-auto px-4 py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <a href={`tel:${PHONE}`} className="text-amber-400 font-bold text-lg hover:text-amber-300 transition-colors">
            {PHONE_DISPLAY}
          </a>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-2">
              ...
              <a href={`tel:${PHONE}`} className="hover:text-amber-400 transition-colors">{PHONE_DISPLAY}</a>
            </li>
            <li className="flex items-start gap-2">
